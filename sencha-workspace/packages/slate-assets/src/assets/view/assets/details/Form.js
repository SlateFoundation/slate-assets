Ext.define('Slate.assets.view.assets.details.Form', {
...
//                field.initValue();
    ...
    updateSelectedAsset: function(asset, oldAsset) {
        var me = this,
            ...
            assigneeCombo, assigneeIdCombo, assigneeModel,
...
//            debugger;
    ...
    getModelFromValue: function(value, returnObject) {
        var model;
        ...
        if (returnObject === true) {
            ...
            return model.split('.').reduce(index, window);
        } else {
            return model;
        }
